...
const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-10 w-60 h-60 bg-yellow-300 rounded-full mix-blend-multiply    filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
