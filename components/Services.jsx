...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-1/3 w-72 h-72 bg-red-300 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-6000"></div>
